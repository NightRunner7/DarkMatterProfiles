...
# ------------------------------- USEFUL FUNCTIONS ------------------------------- #
def create_NFW_class(file_name, _beta):
    ...
    gravo_data = pd.read_csv(file_name, sep='\t', names=['t', 'r', 'rho', 'velDis'])
    ...
    nfw_class = gravoF.GravothermalData(gravo_data['t'], gravo_data['r'], gravo_data['rho'],
                                        gravo_data['velDis'], beta=_beta)
...
# --- gravothermal
gravo_file_1 = "gravoTest_M_10.699_t_2051.1_sigma_1.0_beta_1.0_dT_-4.0_.csv"
gravo_file_2 = "gravoTest_M_10.699_t_2051.1_sigma_1.0_beta_1.0_dT_-3.0_.csv"
gravo_file_3 = "gravoTest_M_10.699_t_2051.1_sigma_1.0_beta_1.0_dT_-2.0_.csv"
gravo_file_4 = "ρσsol_M_10.699_t_2200.42_sigma_1.0_beta_0.6_dT_-4.0_.csv"
gravo_file_5 = "gravoTest_M_10.699_t_2051.1_sigma_1.0_beta_0.6_dT_-2.0_.csv"
gravo_file_6 = "gravoTestVol2_M_10.699_t_2051.1_sigma_1.0_beta_0.6_dT_-2.0_.csv"


fileList = [gravo_file_1, gravo_file_2, gravo_file_3, gravo_file_4, gravo_file_5, gravo_file_6]
...
for i in range(0, fileNum):
    # --- FILE i
    NFW_class = create_NFW_class(fileList[i], param["beta"][i])
