...
def plotDensity(NFW_profile, SIDM_LoDens, SIDM_HiDens, val_r1):
    """
    Draw the plot, which presents how looks like the CDM-only density profile, Isothermal density profile
    ...
    """
    plot_r = np.logspace(-3.0, 2.0, num=300)  # [kpc]
    # ------------------------------ NFW PROFILE ------------------------------ #
