...
from IsothermalSIDMModelWithBaryons import deltaSqare
...
def plotFullComparison(NFW_profile, SIDM_LoDens, SIDM_HiDens, val_r1, sim_set, r_low=-3.0, r_bin=500):
    ...
    # large baryon size
    rhob0 = 1e-6  # 1e-6, 326502405.13772416 [M_sun/kpc^3]
    r0 = 100.  # 100. , 0.7870057685088806 [M_sun]
    ...
    def cal_delta(rho_dm0, sigma_0):
        ...
        return deltaSqare(p, rhob0, r0, rhoCDM1, MCDM1, r)
...
def plotFullComparison_vol2(NFW_profile,
    ...
    # use an arbitrarily low value for baryon density and an arbitrarily
    # large baryon size
    rhob0 = 326502405.13772416  # 1e-6, 326502405.13772416 [M_sun/kpc^3]
    r0 = 0.7870057685088806  # 100., 0.7870057685088806 [M_sun]
    ...
    plt.xlim(0.3 * 0.5 * nu_at_r1, 3 * 2.0 * nu_at_r1)
    ax.set_xscale('log')
    ax.set_yscale('log')
    # grid
    ax.grid(which='minor', alpha=0.2)
