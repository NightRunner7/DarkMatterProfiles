...
sigma_m = 70  # [cm^2/g] annihilation cross-section
sigma_m_SI = sigma_m * 10**(-4) * 10**3  # [m^2/kg]
M_vir = 1*11**10  # [M_sun] Viral mass
...
LowDense = False  # differentiate Low dense or High dense: which data save.
...
plt.loglog(tage_grid, r1_new, marker="o", markersize=3, linewidth=1.2, label="r1")
